...
// Page Routines
Controller::Instance()->PageManager->excecuteGeneralPageLoadingRoutines(Page::Datenschutz, false);
...
<head>
   ...
   <title>Lernoo | Datenschutz</title>
  <!--Start icon in title -->
...
<body id="body">
   ...
   <div class="body-main-datenschutz">
      <div class="title-datenschutz">
         ...
         <p>Wichtig sind uns Ihre Privatsphäre und Ihr Vertrauen</p>
      </div>
      <div class="body-datenschutz">
         <p>
            Wir freuen uns sehr über Ihr Interesse an unserem Unternehmen.
            Datenschutz hat einen besonders hohen Stellenwert für die
            Geschäftsleitung der <b>KEMA</b>. Eine Nutzung der Internetseiten <b>KEMA</b> ist grundsätzlich ohne jede
         ...
         <p>
            ...
            Übereinstimmung mit den für die <b>KEMA</b> geltenden
         ...
         <p>
            Die <b>KEMA</b> hat als für die Verarbeitung Verantwortlicher
         ...
         <p>
            1. Begriffsbestimmungen <br />Die Datenschutzerklärung der <b>KEMA</b>
         ...
         <p>
            1. d) Einschränkung der Verarbeitung <br />
         ...
         <p>
            1. g) Verantwortlicher oder für die Verarbeitung Verantwortlicher <br />
         ...
         <p> 2. Name und Anschrift des für
            die Verarbeitung Verantwortlichen Verantwortlicher im Sinne der
         ...
         <p> <b>KEMA Adresse Tel: KEMA Tel</b></p>
         </p>
         <p> 3. Cookies <br>
            Die Internetseiten der <b>KEMA</b> verwenden Cookies. Cookies sind Textdateien, welche über einen
            ...
            Durch den Einsatz von Cookies kann die <b>KEMA</b> den Nutzern dieser Internetseite nutzerfreundlichere
         ...
         <p> 4. Erfassung von allgemeinen Daten und Informationen <br>
            Die Internetseite der <b>KEMA</b> erfasst mit jedem Aufruf der Internetseite durch eine betroffene Person
         ...
         <p>Bei der Nutzung dieser allgemeinen Daten und Informationen zieht die <b>KEMA</b> keine Rückschlüsse auf die
            ...
            werden durch die <b>KEMA</b> daher einerseits statistisch und ferner mit dem Ziel ausgewertet, den
         ...
         <p> 5. Registrierung auf unserer Internetseite <br>
         ...
         <p>Der für die Verarbeitung Verantwortliche erteilt jeder betroffenen Person jederzeit auf Anfrage Auskunft
            ...
            betroffenen Person, soweit dem keine gesetzlichen Aufbewahrungspflichten entgegenstehen. Ein in dieser
            Datenschutzerklärung namentlich benannter Datenschutzbeauftragter und die Gesamtheit der Mitarbeiter des für
            die Verarbeitung Verantwortlichen stehen der betroffenen Person in diesem Zusammenhang als Ansprechpartner
            zur Verfügung.</p>
         <p> 6. Abonnement unseres Newsletters <br>
            Auf der Internetseite der <b>KEMA</b> wird den Benutzern die Möglichkeit eingeräumt, den Newsletter unseres
         ...
         <p>Die <b>KEMA</b> informiert ihre Kunden und Geschäftspartner in regelmäßigen Abständen im Wege eines
         ...
         <p>Bei der Anmeldung zum Newsletter speichern wir ferner die vom Internet-Service-Provider (ISP) vergebene
            ...
            Datum und die Uhrzeit der Anmeldung. Die Erhebung dieser Daten ist erforderlich, um den(möglichen)
         ...
         <p> 7. Newsletter-Tracking <br>
            Die Newsletter der <b>KEMA</b> enthalten sogenannte Zählpixel. Ein Zählpixel ist eine Miniaturgrafik, die in
            solche E-Mails eingebettet wird, welche im HTML-Format versendet werden, um eine Logdatei-Aufzeichnung und
            eine Logdatei-Analyse zu ermöglichen. Dadurch kann eine statistische Auswertung des Erfolges oder
            Misserfolges von Online-Marketing-Kampagnen durchgeführt werden. Anhand des eingebetteten Zählpixels kann
            die <b>KEMA</b> erkennen, ob und wann eine E-Mail von einer betroffenen Person geöffnet wurde und welche in
            der E-Mail befindlichen Links von der betroffenen Person aufgerufen wurden.
         </p>
         <p>Solche über die in den Newslettern enthaltenen Zählpixel erhobenen personenbezogenen Daten, werden von dem
            für die Verarbeitung Verantwortlichen gespeichert und ausgewertet, um den Newsletterversand zu optimieren
            ...
            Verantwortlichen gelöscht. Eine Abmeldung vom Erhalt des Newsletters deutet die <b>KEMA</b> automatisch als
            Widerruf.</p>
         <p> 8. Kontaktmöglichkeit über die Internetseite <br>
            Die Internetseite der <b>KEMA</b> enthält aufgrund von gesetzlichen Vorschriften Angaben, die eine schnelle
         ...
         <p> 9. Abonnement von Kommentaren im Blog auf der Internetseite <br>
            Die im Blog der <b>KEMA</b> abgegebenen Kommentare können grundsätzlich von Dritten abonniert werden.
         ...
         <p>Sofern sich eine betroffene Person für die Option entscheidet, Kommentare zu abonnieren, versendet der für
            die Verarbeitung Verantwortliche eine automatische Bestätigungsmail, um im Double-Opt-In-Verfahren zu
            überprüfen, ob sich wirklich der Inhaber der angegebenen E-Mail-Adresse für diese Option entschieden hat.
            Die Option zum Abonnement von Kommentaren kann jederzeit beendet werden.</p>
         <p> 10. Routinemäßige Löschung und Sperrung von personenbezogenen Daten
         ...
         <p>11. Rechte der betroffenen Person <br>
         ...
         <p> - die Verarbeitungszwecke <br>
            ...
            <br> - die Empfänger oder Kategorien von Empfängern, gegenüber denen die personenbezogenen Daten offengelegt
            worden sind oder noch offengelegt werden, insbesondere bei Empfängern in Drittländern oder bei
            internationalen Organisationen
            <br> - falls möglich die geplante Dauer, für die die personenbezogenen Daten gespeichert werden, oder, falls
            dies nicht möglich ist, die Kriterien für die Festlegung dieser Dauer
            <br> - das Bestehen eines Rechts auf Berichtigung oder Löschung der sie betreffenden personenbezogenen Daten
            oder auf Einschränkung der Verarbeitung durch den Verantwortlichen oder eines Widerspruchsrechts gegen diese
            Verarbeitung
            <br> - das Bestehen eines Beschwerderechts bei einer Aufsichtsbehörde
            <br> - wenn die personenbezogenen Daten nicht bei der betroffenen Person erhoben werden: Alle verfügbaren
            Informationen über die Herkunft der Daten
            <br> - das Bestehen einer automatisierten Entscheidungsfindung einschließlich Profiling gemäß Artikel 22
            Abs.1 und 4 DS-GVO und — zumindest in diesen Fällen — aussagekräftige Informationen über die involvierte
         ...
         <p> c) Recht auf Berichtigung <br>
            ...
            — auch mittels einer ergänzenden Erklärung — zu verlangen.Möchte eine betroffene Person dieses
            Berichtigungsrecht in Anspruch nehmen, kann sie sich hierzu jederzeit an unseren Datenschutzbeauftragten
         ...
         <p> - Die personenbezogenen Daten wurden für solche Zwecke erhoben oder auf sonstige Weise verarbeitet, für
            welche sie nicht mehr notwendig sind.
            <br>- Die betroffene Person widerruft ihre Einwilligung, auf die sich die Verarbeitung gemäß Art. 6 Abs. 1
            Buchstabe a DS-GVO oder Art. 9 Abs. 2 Buchstabe a DS-GVO stützte, und es fehlt an einer anderweitigen
            Rechtsgrundlage für die Verarbeitung.
            <br>- Die betroffene Person legt gemäß Art. 21 Abs. 1 DS-GVO Widerspruch gegen die Verarbeitung ein, und es
            ...
            <br>- Die Löschung der personenbezogenen Daten ist zur Erfüllung einer rechtlichen Verpflichtung nach dem
            Unionsrecht oder dem Recht der Mitgliedstaaten erforderlich, dem der Verantwortliche unterliegt.
            <br>- Die personenbezogenen Daten wurden in Bezug auf angebotene Dienste der Informationsgesellschaft gemäß
            Art. 8 Abs. 1 DS-GVO erhoben.
         </p>
         <p>Sofern einer der oben genannten Gründe zutrifft und eine betroffene Person die Löschung von
            personenbezogenen Daten, die bei der <b>KEMA</b> gespeichert sind, veranlassen möchte, kann sie sich hierzu
            jederzeit an unseren Datenschutzbeauftragten oder einen anderen Mitarbeiter des für die Verarbeitung
            Verantwortlichen wenden. Der Datenschutzbeauftragte der <b>KEMA</b> oder ein anderer Mitarbeiter wird
            veranlassen, dass dem Löschverlangen unverzüglich nachgekommen wird.</p>
         <p>Wurden die personenbezogenen Daten von der <b>KEMA</b> öffentlich gemacht und ist unser Unternehmen als
            Verantwortlicher gemäß Art. 17 Abs. 1 DS-GVO zur Löschung der personenbezogenen Daten verpflichtet, so
            trifft die <b>KEMA</b> unter Berücksichtigung der verfügbaren Technologie und der Implementierungskosten
            ...
            soweit die Verarbeitung nicht erforderlich ist. Der Datenschutzbeauftragte der <b>KEMA</b> oder ein anderer
         ...
         <p> - Die Richtigkeit der personenbezogenen Daten wird von der betroffenen Person bestritten, und zwar für eine
            ...
            <br>- Die Verarbeitung ist unrechtmäßig, die betroffene Person lehnt die Löschung der personenbezogenen
            Daten ab und verlangt stattdessen die Einschränkung der Nutzung der personenbezogenen Daten.
            <br>- Der Verantwortliche benötigt die personenbezogenen Daten für die Zwecke der Verarbeitung nicht länger,
            die betroffene Person benötigt sie jedoch zur Geltendmachung, Ausübung oder Verteidigung von
            Rechtsansprüchen.
            <br>- Die betroffene Person hat Widerspruch gegen die Verarbeitung gem. Art. 21 Abs. 1 DS-GVO eingelegt und
            es steht noch nicht fest, ob die berechtigten Gründe des Verantwortlichen gegenüber denen der betroffenen
            Person überwiegen.
         </p>
         <p>Sofern eine der oben genannten Voraussetzungen gegeben ist und eine betroffene Person die Einschränkung von
            personenbezogenen Daten, die bei der <b>KEMA</b> gespeichert sind, verlangen möchte, kann sie sich hierzu
            jederzeit an unseren Datenschutzbeauftragten oder einen anderen Mitarbeiter des für die Verarbeitung
            Verantwortlichen wenden. Der Datenschutzbeauftragte der <b>KEMA</b> oder ein anderer Mitarbeiter wird die
         ...
         <p>f) Recht auf Datenübertragbarkeit <br>
            ...
            erfolgt, welche dem Verantwortlichen übertragen wurde.Ferner hat die betroffene Person bei der Ausübung
            ihres Rechts auf Datenübertragbarkeit gemäß Art. 20 Abs. 1 DS-GVO das Recht, zu erwirken, dass die
            personenbezogenen Daten direkt von einem Verantwortlichen an einen anderen Verantwortlichen übermittelt
            ...
            betroffene Person jederzeit an den von der <b>KEMA</b> bestellten Datenschutzbeauftragten oder einen anderen
            Mitarbeiter wenden.
         </p>
         <p>g) Recht auf Widerspruch <br>
            ...
            Profiling.Die <b>KEMA</b> verarbeitet die personenbezogenen Daten im Falle des Widerspruchs nicht mehr, es
            ...
            Ausübung oder Verteidigung von Rechtsansprüchen.Verarbeitet die <b>KEMA</b> personenbezogene Daten, um
            ...
            gegenüber der <b>KEMA</b> der Verarbeitung für Zwecke der Direktwerbung, so wird die <b>KEMA</b> die
            personenbezogenen Daten nicht mehr für diese Zwecke verarbeiten.Zudem hat die betroffene Person das Recht,
            aus Gründen, die sich aus ihrer besonderen Situation ergeben, gegen die sie betreffende Verarbeitung
            personenbezogener Daten, die bei der <b>KEMA</b> zu wissenschaftlichen oder historischen Forschungszwecken
            oder zu statistischen Zwecken gemäß Art. 89 Abs. 1 DS-GVO erfolgen, Widerspruch einzulegen, es sei denn,
            eine solche Verarbeitung ist zur Erfüllung einer im öffentlichen Interesse liegenden Aufgabe erforderlich.
         </p>
         <p>Zur Ausübung des Rechts auf Widerspruch kann sich die betroffene Person direkt an den
            Datenschutzbeauftragten der <b>KEMA</b> oder einen anderen Mitarbeiter wenden. Der betroffenen Person steht
            es ferner frei, im Zusammenhang mit der Nutzung von Diensten der Informationsgesellschaft, ungeachtet der
         ...
         <p>h) Automatisierte Entscheidungen im Einzelfall einschließlich Profiling <br>
            ...
            erfolgt sie mit ausdrücklicher Einwilligung der betroffenen Person, trifft die <b>KEMA</b> angemessene
            ...
            Rechte mit Bezug auf automatisierte Entscheidungen geltend machen, kann sie sich hierzu jederzeit an unseren
         ...
         <p>12. Datenschutz bei Bewerbungen und im Bewerbungsverfahren <br>
         ...
         <p>13. Datenschutzbestimmungen zu Einsatz und Verwendung von Facebook <br>
         ...
         <p>Ein soziales Netzwerk ist ein im Internet betriebener sozialer Treffpunkt, eine Online-Gemeinschaft, die es
            ...
            es der Internetgemeinschaft, persönliche oder unternehmensbezogene Informationen bereitzustellen. Facebook
            ermöglicht den Nutzern des sozialen Netzwerkes unter anderem die Erstellung von privaten Profilen, den
            Upload von Fotos und eine Vernetzung über Freundschaftsanfragen.</p>
         ...
         <p>abgerufen werden. Im Rahmen dieses technischen Verfahrens erhält Facebook Kenntnis darüber, welche konkrete
         ...
         <p>Sofern die betroffene Person gleichzeitig bei Facebook eingeloggt ist, erkennt Facebook mit jedem Aufruf
            ...
            Internetseite integrierten Facebook-Buttons, beispielsweise den „Gefällt mir“-Button, oder gibt die
            betroffene Person einen Kommentar ab, ordnet Facebook diese Information dem persönlichen
            Facebook-Benutzerkonto der betroffenen Person zu und speichert diese personenbezogenen Daten.</p>
         ...
         <p>abrufbar ist, gibt Aufschluss über die Erhebung, Verarbeitung und Nutzung personenbezogener Daten durch
            ...
            eine Datenübermittlung an Facebook zu unterdrücken. Solche Applikationen können durch die betroffene Person
            genutzt werden, um eine Datenübermittlung an Facebook zu unterdrücken.</p>
         <p>14. Datenschutzbestimmungen zu Einsatz und Verwendung von Google+
         ...
         <p>Betreibergesellschaft von Google+ ist die Google Inc., 1600 Amphitheatre Pkwy, Mountain View, CA 94043-1351,
            USA.</p>
         <p>Durch jeden Aufruf einer der Einzelseiten dieser Internetseite, die durch den für die Verarbeitung
            ...
            zu Google+ sind unter</p>
         <p><a href="https://developers.google.com/+/">https://developers.google.com/+/</a></p>
         <p>abrufbar.</p>
         <p>Sofern die betroffene Person gleichzeitig bei Google+ eingeloggt ist, erkennt Google mit jedem Aufruf
            unserer Internetseite durch die betroffene Person und während der gesamten Dauer des jeweiligen Aufenthaltes
            auf unserer Internetseite, welche konkrete Unterseite unserer Internetseite die betroffene Person besucht.
            Diese Informationen werden durch die Google+ Schaltfläche gesammelt und durch Google dem jeweiligen
            Google+-Account der betroffenen Person zugeordnet.</p>
         <p>Betätigt die betroffene Person einen der auf unserer Internetseite integrierten Google+-Buttons und gibt
            damit eine Google+1 Empfehlung ab, ordnet Google diese Information dem persönlichen Google+-Benutzerkonto
            der betroffenen Person zu und speichert diese personenbezogenen Daten. Google speichert die
            Google+1-Empfehlung der betroffenen Person und macht diese in Übereinstimmung mit den von der betroffenen
            Person diesbezüglich akzeptierten Bedingungen öffentlich zugänglich. Eine von der betroffenen Person auf
            dieser Internetseite abgegebene Google+1-Empfehlung wird in der Folge zusammen mit anderen personenbezogenen
            ...
            Google-Suchmaschine, dem Google-Konto der betroffenen Person oder an sonstigen Stellen, beispielsweise auf
            ...
            unterschiedlichen Dienste von Google zu verbessern oder zu optimieren.</p>
         <p>Google erhält über die Google+-Schaltfläche immer dann eine Information darüber, dass die betroffene Person
            unsere Internetseite besucht hat, wenn die betroffene Person zum Zeitpunkt des Aufrufs unserer Internetseite
            gleichzeitig bei Google+ eingeloggt ist; dies findet unabhängig davon statt, ob die betroffene Person die
            Google+-Schaltfläche anklickt oder nicht.</p>
         <p>Ist eine Übermittlung personenbezogener Daten an Google von der betroffenen Person nicht gewollt, kann diese
            eine solche Übermittlung dadurch verhindern, dass sie sich vor einem Aufruf unserer Internetseite aus ihrem
            Google+-Account ausloggt.</p>
         <p>Weitere Informationen und die geltenden Datenschutzbestimmungen von Google können unter</p>
         <p><a href="https://www.google.de/intl/de/policies/privacy/">
               https://www.google.de/intl/de/policies/privacy/</a></p>
         <p>abgerufen werden. Weitere Hinweise von Google zur Google+1-Schaltfläche können unter</p>
         <p><a
               href="https://developers.google.com/+/web/buttons-policy">https://developers.google.com/+/web/buttons-policy</a>
         </p>
         <p>abgerufen werden.</p>
         <p>15. Datenschutzbestimmungen zu Einsatz und Verwendung von Google-AdWords <br>
            ...
            Suchmaschinenergebnissen von Google als auch im Google-Werbenetzwerk zu schalten. Google AdWords ermöglicht
            es einem Werbetreibenden, vorab bestimmte Schlüsselwörter festzulegen, mittels derer eine Anzeige in den
            Suchmaschinenergebnissen von Google ausschließlich dann angezeigt wird, wenn der Nutzer mit der Suchmaschine
            ein schlüsselwortrelevantes Suchergebnis abruft. Im Google-Werbenetzwerk werden die Anzeigen mittels eines
         ...
         <p>Betreibergesellschaft der Dienste von Google AdWords ist die Google Inc., 1600 Amphitheatre Pkwy, Mountain
            View, CA 94043-1351, USA.</p>
         <p>Der Zweck von Google AdWords ist die Bewerbung unserer Internetseite durch die Einblendung von
            interessenrelevanter Werbung auf den Internetseiten von Drittunternehmen und in den Suchmaschinenergebnissen
            der Suchmaschine Google und eine Einblendung von Fremdwerbung auf unserer Internetseite.</p>
         <p>Gelangt eine betroffene Person über eine Google-Anzeige auf unsere Internetseite, wird auf dem
            ...
            seine Gültigkeit und dient nicht zur Identifikation der betroffenen Person. Über den Conversion-Cookie wird,
            sofern das Cookie noch nicht abgelaufen ist, nachvollzogen, ob bestimmte Unterseiten, beispielsweise der
            Warenkorb von einem Online-Shop-System, auf unserer Internetseite aufgerufen wurden. Durch den
            Conversion-Cookie können sowohl wir als auch Google nachvollziehen, ob eine betroffene Person, die über eine
            AdWords-Anzeige auf unsere Internetseite gelangt ist, einen Umsatz generierte, also einen Warenkauf
            vollzogen oder abgebrochen hat.</p>
         <p>Die durch die Nutzung des Conversion-Cookies erhobenen Daten und Informationen werden von Google verwendet,
            um Besuchsstatistiken für unsere Internetseite zu erstellen. Diese Besuchsstatistiken werden durch uns
            wiederum genutzt, um die Gesamtanzahl der Nutzer zu ermitteln, welche über AdWords-Anzeigen an uns
            vermittelt wurden, also um den Erfolg oder Misserfolg der jeweiligen AdWords-Anzeige zu ermitteln und um
            unsere AdWords-Anzeigen für die Zukunft zu optimieren. Weder unser Unternehmen noch andere Werbekunden von
            Google-AdWords erhalten Informationen von Google, mittels derer die betroffene Person identifiziert werden
            könnte.</p>
         <p>Mittels des Conversion-Cookies werden personenbezogene Informationen, beispielsweise die durch die
         ...
         <p>Ferner besteht für die betroffene Person die Möglichkeit, der interessenbezogenen Werbung durch Google zu
            widersprechen. Hierzu muss die betroffene Person von jedem der von ihr genutzten Internetbrowser aus den
            Link www.google.de/settings/ads aufrufen und dort die gewünschten Einstellungen vornehmen.</p>
         <p>Weitere Informationen und die geltenden Datenschutzbestimmungen von Google können unter</p>
         <p><a href="https://www.google.de/intl/de/policies/privacy/">
               https://www.google.de/intl/de/policies/privacy/</a></p>
         <p>abgerufen werden.</p>
         <p>16. Datenschutzbestimmungen zu Einsatz und Verwendung von Xing <br>
            ...
            Geschäftskontakten sowie das Knüpfen von neuen Businesskontakten ermöglicht. Die einzelnen Nutzer können bei
            Xing ein persönliches Profil von sich anlegen. Unternehmen können beispielsweise Unternehmensprofile
         ...
         <p>Durch jeden Aufruf einer der Einzelseiten dieser Internetseite, die durch den für die Verarbeitung
            ...
            jeweilige Xing-Komponente veranlasst, eine Darstellung der entsprechenden Xing-Komponente von Xing
            herunterzuladen. Weitere Informationen zum den Xing-Plug-Ins können unter https://dev.xing.com/plugins
            abgerufen werden. Im Rahmen dieses technischen Verfahrens erhält Xing Kenntnis darüber, welche konkrete
            Unterseite unserer Internetseite durch die betroffene Person besucht wird.</p>
         <p>Sofern die betroffene Person gleichzeitig bei Xing eingeloggt ist, erkennt Xing mit jedem Aufruf unserer
            ...
            betroffenen Person zugeordnet. Betätigt die betroffene Person einen der auf unserer Internetseite
            integrierten Xing-Buttons, beispielsweise den „Share“-Button, ordnet Xing diese Information dem persönlichen
            Xing-Benutzerkonto der betroffenen Person zu und speichert diese personenbezogenen Daten.</p>
         <p>Xing erhält über die Xing-Komponente immer dann eine Information darüber, dass die betroffene Person unsere
            Internetseite besucht hat, wenn die betroffene Person zum Zeitpunkt des Aufrufs unserer Internetseite
            gleichzeitig bei Xing eingeloggt ist; dies findet unabhängig davon statt, ob die betroffene Person die
            Xing-Komponente anklickt oder nicht. Ist eine derartige Übermittlung dieser Informationen an Xing von der
            betroffenen Person nicht gewollt, kann diese die Übermittlung dadurch verhindern, dass sie sich vor einem
            Aufruf unserer Internetseite aus ihrem Xing-Account ausloggt.</p>
         <p>Die von Xing veröffentlichten Datenschutzbestimmungen, die unter <a href="https://www.xing.com/privacy">
               https://www.xing.com/privacy</a> abrufbar sind,<br> geben Aufschluss über die Erhebung, Verarbeitung und
            Nutzung personenbezogener Daten durch Xing. Ferner hat Xing unter <a
               href="https://www.xing.com/app/share?op=data_protection">
               https://www.xing.com/app/share?op=data_protection</a> Datenschutzhinweise für den XING-Share-Button
            veröffentlicht.</p>
         <p>17. Datenschutzbestimmungen zu Einsatz und Verwendung von YouTube <br>
            ...
            anderen Nutzern die ebenfalls kostenfreie Betrachtung, Bewertung und Kommentierung dieser ermöglicht.
         ...
         <p>Durch jeden Aufruf einer der Einzelseiten dieser Internetseite, die durch den für die Verarbeitung
            ...
            YouTube herunterzuladen. Weitere Informationen zu YouTube können unter</p>
         <p><a href="https://www.youtube.com/yt/about/de/">https://www.youtube.com/yt/about/de/</a> </p>
         <p>abgerufen werden. <br> Im Rahmen dieses technischen Verfahrens erhalten YouTube und Google Kenntnis darüber,
            welche konkrete Unterseite unserer Internetseite durch die betroffene Person besucht wird.</p>
         <p>Sofern die betroffene Person gleichzeitig bei YouTube eingeloggt ist, erkennt YouTube mit dem Aufruf einer
         ...
         <p>YouTube und Google erhalten über die YouTube-Komponente immer dann eine Information darüber, dass die
            ...
            betroffene Person ein YouTube-Video anklickt oder nicht. Ist eine derartige Übermittlung dieser
            Informationen an YouTube und Google von der betroffenen Person nicht gewollt, kann diese die Übermittlung
            dadurch verhindern, dass sie sich vor einem Aufruf unserer Internetseite aus ihrem YouTube-Account ausloggt.
         </p>
         <p>Die von YouTube veröffentlichten Datenschutzbestimmungen, die unter</p>
         <p><a href="https://www.google.de/intl/de/policies/privacy/">
               https://www.google.de/intl/de/policies/privacy/</a></p>
         <p>abrufbar sind,<br> geben Aufschluss über die Erhebung, Verarbeitung und Nutzung personenbezogener Daten
            durch YouTube und Google.</p>
         <p>18. Rechtsgrundlage der Verarbeitung <br>
         ...
         <p>19. Berechtigte Interessen an der Verarbeitung, die von dem Verantwortlichen oder einem Dritten verfolgt
            werden <br>
         ...
         <p>20. Dauer, für die die personenbezogenen Daten gespeichert werden <br>
         ...
         <P>21. Gesetzliche oder vertragliche Vorschriften zur Bereitstellung der personenbezogenen Daten; <br>
         ...
         <p>Wir klären Sie darüber auf, dass die Bereitstellung personenbezogener Daten zum Teil gesetzlich
            ...
            personenbezogenen Daten bereitzustellen, und welche Folgen die Nichtbereitstellung der personenbezogenen
            Daten hätte.</p>
         <p>22. Bestehen einer automatisierten Entscheidungsfindung <br>
            Als verantwortungsbewusstes Unternehmen verzichten wir auf eine automatische Entscheidungsfindung oder ein
            Profiling.
         </p>
         <p>23. Cloudflare <br>
            Technisch gesehen wird die Verbindung von Ihrem Gerät zu unserer Internetseite über das Netzwerk von
            Cloudflare, der Firma Cloudflare Inc., 101 Townsend St San Francisco, CA 94107 geleitet. Damit ist
            Cloudflare in der Lage beispielsweise Angriffe auf unsere Internetseite zu erkennen. Cloudflare hat jedoch
            durch die auf unserer Internetseite stets aktivierte TLS-Verschlüsselung keinen Zugriff auf von Ihnen
            eingegebene Daten. Bei dem Aufruf unserer Internetseite werden in Ihren Webbrowser Cookies von Cloudflare
            gesetzt.
         </p>
         <p>Bei der Nutzung der Webseiten übermittelt Ihr Internet-Browser bzw. das Programm, mit dem Sie die Webseiten
            abrufen, dem technischen Dienstleister, automatisiert Informationen. Dies sind insbesondere Details zum
            verwendeten Browser und Betriebssystem, ein Hinweis auf die Herkunft der zuvor besuchten Seiten (sog.
            Referral-URL), die IP-Adresse des von Ihnen verwendeten Geräts, den Namen Ihres Internet-Providers, sowie
            Datum, Uhrzeit aller Seiten-Aufrufe der Webseiten einschließlich der dabei übermittelten Datenmenge.</p>
         <p>Diese Informationen werden automatisiert von Cloudflare in entsprechenden Protokolldateien, den sog.
            Server-Logfiles, erhoben und gespeichert. Cloudflare verwendet die Protokolldaten für statistische
            Auswertungen zum Zweck des Betriebs, der Sicherheit und der Optimierung des Angebots (z. B. zur
            Identifizierung und Abwehr massenhafter missbräuchlicher Zugriffe im Rahmen von denial-of-Service- (DoS),
            distributed-denial-of-service Attacken (DDoS) oder zur Identifizierung mehrerer legitimer Zugriffe
            verschiedener Geräte unter Verwendung einer IP-Adresse). Bitte lesen Sie hierzu auch die
            Datenschutzbestimmungen von Cloudflare welche unter https://www.cloudflare.com/de-de/privacypolicy/ abrufbar
            sind.</p>
         <p>Bei einem geringen Prozentsatz an Nutzern werden zusätzlich Messfunktionen an den Browser ausgeliefert, um
            Metriken wie Ladezeiten, Übertragungsgeschwindigkeit, Dateigrößen etc. zu ermitteln (Monitoring). Dadurch
            kann die Funktionalität der Webseiten auf dem jeweiligen Endgerät geprüft und verbessert werden. Diese Daten
            werden durch den technischen Dienstleister zur Auswertung anonymisiert und teilweise kumuliert.</p>
         <p>Mit dem Ende der Auswertungsphase werden die Logfiles automatisiert gelöscht. Ohne besondere Auffälligkeiten
            werden Logfiles nach spätestens 90 Tagen automatisch gelöscht. Ein Abgleich der Serverlogs mit eventuell von
            Ihnen innerhalb des Angebots eingegebenen personenbezogenen Daten wird nicht vorgenommen.</p>
         <p>Abhängig von den jeweiligen technischen Gegebenheiten sowie durch die weltweite Präsenz des oben genannten
            Dienstleisters kann nicht ausgeschlossen werden, dass Daten in Territorien außerhalb des EWR bzw. des
            Anwendungsbereichs der DS-GVO übertragen werden. Wir stellen sicher, dass die Dienstleister vertraglich oder
            auf andere Weise ein gleichwertiges Datenschutzniveau garantieren, beispielsweise durch den Abschluss eines
            seitens der EU-Kommission vorgegebenen Datenschutz-Vertrags (sog. EU-Standardvertragsklauseln) sein.</p>
      </div>
   </div>
   <?php
   // Adding Footer
